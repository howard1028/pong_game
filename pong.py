...
wn = turtle.Screen()
wn.title("Pong game by @howard1028")
wn.bgcolor("black")
...
paddle_a.shapesize(stretch_wid=5,stretch_len=1) #20*20px->20*100px
paddle_a.color("white")
paddle_a.penup() #moving without drawing a line
paddle_a.goto(-350,0)
